...
<script>
  data() {
    ...
    lineAreaChartSpline: {
        series: [{
                name: 'ИМЯ ПРИБОРА: 1908378 <br> Индикация датчика',
                data: [1, 2, 0, 7, 6, 5, 7]
            },
            {
              name: `ИМЯ ПРИБОРА: 1908379 <br> Индикация датчика`,
              data: [ 0, 3, 3, 1, 0, 4, 6]
            },
            {
                name: 'ИМЯ ПРИБОРА: 1908380 <br>  <small>Индикация датчика</small>',
                data: [0, 2, 6, 1, 2, 0, 9]
        }],
        chartOptions: {
            dataLabels: {
            ...
            tooltip: {
                y: {
                    formatter: function(val) {
                        return "Есть " + "/" + " Знач. индик. " + "<p style='color: red'>" + val + "</p>"
                    }
                }
            }
        }
  ...
  data() {
    ...
    radialBarChart: {
        ...
        chartOptions: {
            ...
            labels: ['БСПИ _ 1908381', 'ИКЗ _ 1908378', 'ИКЗ _1908379', 'ИКЗ _1908380'],
        }
    },
    radialBarChartCode:
`<template>
