...
<script>
  ...
  // Store Module
  import moduleEventsManagement from './../../store/events/moduleEventsManagement.js'
  ...
  export default {
    ...
    beforeMount() {
      ...
      // this.$store.dispatch("events/GET_EVENTS_FROM_API")
        .then(result => {
          result.data
          // console.log('----- rowData');
          // console.log(result);
    ...
    created() {
      ...
      // if(!moduleEventsManagement.isRegistered) {
      //   this.$store.registerModule('eventsManagement', moduleEventsManagement)
      //   moduleEventsManagement.isRegistered = true
      // }
