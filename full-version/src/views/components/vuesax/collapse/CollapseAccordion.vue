...
<template>
    <vx-card title="Accordion" code-toggler>

        <p>You may need to show only one element at a time. For this add <code>accordion</code> prop to <code>vs-collapse</code></p>
